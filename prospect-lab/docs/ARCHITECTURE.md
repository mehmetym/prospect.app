...
Prospect Lab modüler bir Python uygulamasıdır. Her motor (predictor, news_analyzer, product_engine) bağımsız olarak çalışır, test edilir ve geliştirilir. UI katmanı Streamlit ile sağlanır; landing sayfası statik HTML olarak [prospect.app](https://prospect.app) adresinde yayınlanır.
...
- [prospect.app](https://prospect.app) adresinde yayınlanacak
